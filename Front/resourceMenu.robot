...
Clicar no "${LOGIN}"
    Wait Until Element Is Visible    xpath=//*[@id="root"]//a[@data-test='navbar-conexaoQA']
    Title Should Be                  ConexaoQA
    Click Element                    xpath=//*[@id="root"]//a[@data-test='navbar-login']
...
Cadastrar Perfil
    ...
    Scroll Element Into View         xpath=//*[@id="menu-status"]//*[@data-test='status-1'][@data-value='QA Junior']
    Click Element                    xpath=//*[@id="menu-status"]//*[@data-test='status-1'][@data-value='QA Junior']
    Input Text                       name=company                                                                       Kow
    Input Text                       name=website                                                                       https://www.teste.com/
    ...
    Input Text                       name=githubusername                                                                https://github.com/testeOliveira
    ...
    Input Text                       name=linkedin                                                                      https://www.teste.com/in/gislaine-oliveira/
...
Acesso Perfil
    ...
    Wait Until Element Is Enabled    xpath=//*[@id="root"]//*[@class='large text-primary']
    Title Should Be                  ConexaoQA
    Click Element                    xpath=//*[@id="root"]//a[@data-test='dashboard-editProfile']


Editar Perfil
    Go To                            https://conexaoqa.herokuapp.com/editar-perfil
    Wait Until Element Is Enabled    xpath=//*[@id="root"]//*[@class='large text-primary']
    Title Should Be                  ConexaoQA
    Click Element                    xpath=//*[@id="root"]//*[@data-test='profile-status']
